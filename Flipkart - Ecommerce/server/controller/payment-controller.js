...
export const addPaymentGateway = async (request, response) => { // it takes two parameter called paytmParam, paytmMerchantKey
...
export const paymentResponse = (request, response) => {
    ...
    // this is to verify that is someone hack our filled payment details in between or not
    ...
    if (isVerifySignature) {
        ...
        console.log("Checksum mismatched(i.e Someone Hack your data in between) ");
    }
}
